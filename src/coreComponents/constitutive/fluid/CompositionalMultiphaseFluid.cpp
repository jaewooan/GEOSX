...
void CompositionalMultiphaseFluid::createFluid()
{
  ...
  std::vector< pvt::EOS_TYPE > eos( NP );
  ...
  pvt::ComponentProperties const compProps( NC, components, Mw, Tc, Pc, Omega );

  m_fluid = pvt::MultiphaseSystemBuilder::buildCompositional( phases, eos, pvt::COMPOSITIONAL_FLASH_TYPE::NEGATIVE_OIL_GAS, compProps );
